module TestKeyboardEvent1TextArea exposing (Model, Msg(..), init, leftSide, main, rightSide, source, subscriptions, update, view, viewEvent)

import Browser exposing (element)
import Browser.Dom as Dom
import Html exposing (Attribute, Html, div, h1, h3, p, pre, text, textarea)
